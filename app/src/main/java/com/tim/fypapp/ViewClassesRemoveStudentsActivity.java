...
public class ViewClassesRemoveStudentsActivity extends AppCompatActivity {
                ...
                allClasses.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                        if (++check > 1) {
                            ...
                            Intent selectedClass = new Intent(getApplicationContext(), RemoveStudentsActivity.class);
